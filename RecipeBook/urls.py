...
urlpatterns = [
    ...
    # ex: /Beef/Steak
    path('<category_name>/<recipe_name>', views.RecipeView.as_view(), name='view_recipe'),
    # ex: /Beef/Steak/edit/
    path('<category_name>/<recipe_name>/edit/', views.RecipeEditView.as_view(), name='edit_recipe'),
    # ex: /add_recipe/
